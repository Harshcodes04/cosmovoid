...
exports.sendOTPEmail = async (to, otp) => {
  try {
    ...
    console.error("SMTP Error: Failed to send email (Render Free Tier blocks port 465).");
    console.log(`\n========================================`);
...
exports.sendPasswordResetEmail = async (to, otp) => {
  try {
    ...
    console.error("SMTP Error: Failed to send reset email.");
    console.log(`\n========================================`);
    console.log(`🚀 RESET OTP FOR ${to}: ${otp} 🚀`);
    console.log(`========================================\n`);
  }
};
